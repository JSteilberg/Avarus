...
class Atlas
{
  ...
  map<string, map<string, sf::IntRect>> ReadRectsByKey(string element_key) const;
  ...
  // The first string key is the name of the object type (i.e. "player", "dirt", etc.)
  // The string key for the second map is the name of a specific sf::IntRect subsection
  // of the atlas for a specific texture for a given object (i.e. "norm", "step4", etc.)
